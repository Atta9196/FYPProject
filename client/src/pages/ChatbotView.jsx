    ...
    return (
        <AppLayout>
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
                {/* Header */}
                <div className="bg-white/80 backdrop-blur-xl border-b border-slate-200/70 shadow-sm sticky top-0 z-20">
                    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between h-14 sm:h-16 gap-2">
                            <div className="flex items-center gap-2 sm:gap-4 min-w-0">
                                ...
                                <h1 className="text-base sm:text-xl md:text-2xl font-bold text-slate-800 truncate">IELTS Assistant</h1>
                            </div>
                            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                                <button
                                    onClick={handleClearHistory}
                                    className="px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs sm:text-sm font-medium transition-colors"
                                ...
                                <button
                                    ...
                                    className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs sm:text-sm font-medium transition-colors"
                                >
                                    Profile
                                </button>
                            </div>
                ...
                <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
                    ...
                    <div className="text-center mb-3 sm:mb-6">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                            IELTSCoach
                        </h2>
                    </div>

                    {/* Chat Container */}
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200/50 overflow-hidden flex flex-col h-[calc(100vh-220px)] sm:h-[calc(100vh-260px)] min-h-[400px] sm:min-h-[500px]">
                        {/* Chat Header */}
